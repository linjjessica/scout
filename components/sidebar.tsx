        ...
        <div className="rounded-[1.25rem] bg-white/50 border border-neutral-100 p-4 space-y-2.5">
          ...
          <div className="pt-2 mt-2 border-t border-neutral-100 flex items-center justify-between">
            <p className="text-[10px] font-medium text-neutral-400">
              Made by <a href="https://www.linkedin.com/in/jjessicalin/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 font-bold underline decoration-indigo-200 underline-offset-2 hover:text-indigo-500 transition-colors">Jessica Lin</a>
            </p>
          </div>
        </div>
      </div>
